...
static bool twi_master_write(uint8_t * data, uint16_t data_length, bool issue_stop_condition)
{
 ...
 */
static bool twi_master_read(uint8_t * data, uint16_t data_length, bool issue_stop_condition)
{
